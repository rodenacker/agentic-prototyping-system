...
3. **Prototype Requirements**: `docs/project-docs/[prototype-name]/prototype-requirements.md`
...
3. **`docs/project-docs/[prototype-name]/prototype-requirements.md`**
...
- Read `docs/project-docs/[prototype-name]/prototype-requirements.md` completely
...
- [ ] Implements `docs/project-docs/[prototype-name]/prototype-requirements.md` specifications
