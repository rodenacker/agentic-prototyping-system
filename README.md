...
## Table of Contents
1. [Prototyping Framework](#prototyping-framework)
   1. [Table of Contents](#table-of-contents)
   2. [Quick Start](#quick-start)
   3. [Purpose](#purpose)
   4. [How It Works](#how-it-works)
      1. [Phase 1: Project Foundation (Once Per Project)](#phase-1-project-foundation-once-per-project)
      2. [Modularization: Breaking Your System Into Prototypes](#modularization-breaking-your-system-into-prototypes)
      3. [Phase 2: Prototype Cycle (Repeat Per Prototype)](#phase-2-prototype-cycle-repeat-per-prototype)
   5. [Getting Started](#getting-started)
      1. [Step 1: Run the Setup Script](#step-1-run-the-setup-script)
      2. [Step 2: Navigate and Start Claude Code](#step-2-navigate-and-start-claude-code)
      3. [Step 3: Start the Project Orchestration Agent](#step-3-start-the-project-orchestration-agent)
      4. [Alternative: Run Individual Agent Commands](#alternative-run-individual-agent-commands)
      5. [What to Expect](#what-to-expect)
   6. [Detailed Workflow](#detailed-workflow)
      1. [Phase 1: Project Foundation (One-Time Setup)](#phase-1-project-foundation-one-time-setup)
         1. [1. Business Requirements Gathering](#1-business-requirements-gathering)
         2. [2. Design Token Extraction](#2-design-token-extraction)
         3. [3. Application Setup](#3-application-setup)
      2. [Phase 2: Prototype Cycle (Repeat Per Prototype)](#phase-2-prototype-cycle-repeat-per-prototype-1)
         1. [1. Prototype Requirements Research](#1-prototype-requirements-research)
         2. [2. Prototype Design](#2-prototype-design)
         3. [3. Prototype Implementation](#3-prototype-implementation)
         4. [4. Code Review \& Compliance Gate](#4-code-review--compliance-gate)
         5. [5. Validation \& Revision (Optional)](#5-validation--revision-optional)
